...
class LowBloodSuger extends StatefulWidget {
  const LowBloodSuger({super.key});

  @override
  State<LowBloodSuger> createState() => _LowBloodSugerState();
}

class _LowBloodSugerState extends State<LowBloodSuger> {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        AddressPregnancy(text: "Do you suffer from pale skin?"),
        Row(
          children: [
            const SizedBox(
              width: 35,
        ...
        if (showField1)
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  children: [
                    PregnancyInformation(text: "Drink enough water", width: widthscreen * 0.7,),
          ...
          //22222222
           AddressPregnancy(text: "Do you suffer from Sweating?"),
        Row(
          children: [
            const SizedBox(
              width: 35,
        ...
        if (showField3)
          ...
          //44444444444444
           AddressPregnancy(text: "Do you suffer from Accelerated \nheart beat or stress"),
        Row(
          children: [
            const SizedBox(
              width: 35,
