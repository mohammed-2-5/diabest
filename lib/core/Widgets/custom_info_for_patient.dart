              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      AppStrings.weight,
                      style: CustomTextStyles.lohit500style20.copyWith(fontSize: 18.sp),
                    ),
                    ProfileFormField(
                      controller: BlocProvider.of<ProfileCubit>(context).weight,
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    ProfileFormField(
                      controller: BlocProvider.of<ProfileCubit>(context).height,
                      hint: AppStrings.enteryour,
